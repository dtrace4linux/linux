...
#pragma ident	"@(#)dtrace_asm.s	1.3	04/11/17 SMI"
...
{ return (0); }
	...
	rdpr	%ver, %g3		! hang onto maxwin since we'll need
	and	%g3, VER_MAXWIN, %g3	! it for our modular arithmetic
...
1:
	subcc	%g2, 1, %g2		! decrement the current window
	...
	subcc	%g5, 1, %g5		! decrement the count
