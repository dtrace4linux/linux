...
#define	DTRACE_C_PRDEFS	0x0400	/* Permit provider definitions in programs */
...
#define	DTRACE_C_MASK	0x1fff	/* mask of all valid flags to dtrace_*compile */
...
extern void dtrace_dof_destroy(void *);
...
extern int dtrace_provider_modules(dtrace_hdl_t *,
    const char **provmods, int nmods);
