...
#pragma ident	"@(#)fasttrap_impl.h	1.6	04/10/06 SMI"
...
extern int fasttrap_uread(proc_t *, void *, size_t, uintptr_t);
extern int fasttrap_uwrite(proc_t *, void *, size_t, uintptr_t);
