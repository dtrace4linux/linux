...
#if linux
			/***********************************************/
			/*   Solaris  has  a  portable  C issue. Sign  */
			/*   extension  of  0xffff0000 will make this  */
			/*   assert  fail prematurely. Or maybe its a  */
			/*   gcc-4.6.1 issue.			       */
			/***********************************************/
			assert(!(arg & ((unsigned long) UINT16_MAX << args[i].shift)));
#else
